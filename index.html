    ...
    <div class="chat_window">
        ...
        <nav class="nav">
            ...
            <div class="navFooter">
                ...
                <div class="links">
                    <a href="http://wj.lzlspyxgs.asia/" target="_blank"
                        rel="noopener noreferrer">资源导航</a>
                </div>
            </div>
        </nav>
        <div class="top_menu">
            ...
            <div id="setDialog" style="display:none;">
                ...
                <div id="convOption">
                    <div class="presetSelect presetModelCls">
                     <label for="preSetModel" style="display: none;">GPT模型</label>
                     <select id="preSetModel" style="display: none;">
                    ...
                    <div>
                        <input class="inputTextClass" placeholder="https://example.com/" id="apiHostInput" value="https://closeai.deno.dev/" style="display:none;" />
                    </div>
                    <div>
                        <input class="inputTextClass" type="password" placeholder="sk-xxxxxx" id="keyInput"
                            style="display: none;" value="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"/>
                    </div>
                    <div>
                ...
                <div id="recOption" style="display: none;">
                    <div id="noRecTip" style="display: block;">当前语音识别暂未开启,请等待更新！</div>
        ...
        <div class="bottom_wrapper clearfix">
            <div class="message_input_wrapper">
                <textarea class="message_input_text" spellcheck="false" placeholder="Send a message..." id="chatinput"></textarea>
